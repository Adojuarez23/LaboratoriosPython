...
while(True):
    ...
    # Si la cantidad de componentes es igual a 3. 
    # Entonces inicia el procesamiento. 
    elif (cantidad == 3):

        # Adjunta los nombres en una lista (vacia) en un solo string. 
        nombres = []
        ...
        ''' Se convierte los strings de nomnbres y apellidos en una sola,
            para así adjuntarlo en la lista vacía "nombres1" 
        '''
